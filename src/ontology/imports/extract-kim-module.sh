...
java -jar robot.jar merge --input schulfaecher.ttl extract --method TOP --term 'http://www.w3.org/2004/02/skos/core#Concept'  --output kim-extracted.ttl

# Create Extracted module and annotate with new ontology information
java -jar robot.jar merge --input kim-extracted.ttl annotate --ontology-iri https://w3id.org/schulfach/sf/imports/kim_import.owl --version-iri https://w3id.org/schulfach/sf/imports/kim_import.owl --output kim-extracted.ttl
